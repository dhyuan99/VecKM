...
class NormalEstimator(nn.Module):
    def __init__(self, args):
        ...
        self.point_batch_size = 10000
        self.num_neighbors = args.num_neighbors
        print(f"num_neighbors={self.num_neighbors}")
    ...
    def forward(self, pts, normal):
        ...
        x = get_graph_feature(pts, k=self.num_neighbors)
        x = self.conv1(x)
        ...
        x = F.leaky_relu(self.bn6(self.fc6(x)), negative_slope=0.2)
        x = F.leaky_relu(self.bn7(self.fc7(x)), negative_slope=0.2)
        x = self.fc8(x)
        return x, normal[index]
